  ...
  setup(props, { emit }) {
    ...
    const handleSignUp = async () => {
      ...
      try {
        ...
        console.log(
          'Call Auth0 create user, then log in user, then store credentials for requests to my API'
        )
  ...
  <div id="signup-container" class="flex flex-col">
    <div class="flex flex-col items-center justify-center h-full bg-gray-100 rounded-xl">
      <div class="p-6 max-w-md w-full bg-white rounded-xl shadow-md">
        <h1 class="title text-2xl font-bold mb-2 text-black">Welcome to CaterBot!</h1>
        <p class="mb-4 text-gray-600">Start saving time NOW! Only a few simple steps to start.</p>
